<template>
  <div class="privacy page">
    <h2>Privacy</h2>
    <p>Your privacy is very important to us. This privacy policy applies to this website and the server powering it. 
      <br />
      <br />
    ...
    <p class="sub">If you have any questions or need more information about the privacy policy, please contact me at <a href="http://twitter.com/JacobLucado">Twitter</a>.</p>
  </div>
</template>
