<template>
  <div class="privacy page">
    ...
    <p class="sub">If you have any questions or need more information about the privacy policy, please contact me at <a href="twitter.com/JacobLucado">Twitter</a>.</p>
  </div>
</template>
